...
// ============================================================
// (admin-v2)/v2/page.tsx — admin-v2 토대 쇼케이스 (R1)
//   정본 컴포넌트(kit + shell + blocks)를 한 화면에 전부 렌더 →
//   수빈이 시안 스크린샷(screenshots/)과 육안 1:1 대조.
//   부모 layout 의 AdminShell 안에 들어가므로 useAdminShell 컨텍스트 사용 가능.
// ============================================================
