...
// 시안 v2(1) Terms.jsx 스타일 박제 — eyebrow + breadcrumb + v2.1 날짜 + 카드 컨테이너.
// 본문 13조 + 부칙은 기존 그대로 보존.
  ...
  return (
    <div className="page mx-auto" style={{ maxWidth: 880 }}>
      ...
      <div style={{ fontSize: 12, color: "var(--ink-mute)", marginBottom: 10 }}>
        ...
        {" › "}
        <span style={{ color: "var(--color-text-primary)" }}>이용약관</span>
      </div>

      {/* eyebrow + 제목 + v2.1 날짜 (시안 톤) */}
      ...
      >
        문의: <a href="mailto:bdr.wonyoung@gmail.com" className="hover:underline">bdr.wonyoung@gmail.com</a>
        {" "}· 본 약관에 동의하지 않으시면 서비스 이용이 제한될 수 있습니다.
      </div>
