...
| Admin Toss cleanup | In Progress | Active tournament operate files scan clean for `ta-*`; admin backoffice scans clean for `au-*`, and global sidebar/user-menu ligature text is removed. |
