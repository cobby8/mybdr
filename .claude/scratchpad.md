...
<!-- 5/4 알기자 누락 7매치 backfill + 가로 스크롤 indicator + 5/3 알기자 진단 + 5/4 카테고리 fade overlay + 시간 데이터 소실 매치 안내 배너 + 5/4 대회·경기 헤더 UI 개편 + 알기자 Phase 1 DB 마이그 + 옵션 A 도메인 sub-agent 박제 절단 (듀얼 표준 default P3~P7 prepend로 10건 유지) — 복원: git log -- .claude/scratchpad.md -->
