...
<!-- 5/4 가로 스크롤 indicator + 5/3 알기자 진단 + 5/4 카테고리 fade overlay + 시간 데이터 소실 매치 안내 배너 + 5/4 대회·경기 헤더 UI 개편 절단 (P3 결정 + Phase 7 prepend로 10건 유지) — 복원: git log -- .claude/scratchpad.md -->
