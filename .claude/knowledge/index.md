# 프로젝트 지식 목차
> 최종 갱신: 2026-05-02 (STL Phase 1 도입 — Flutter PBP 누락 응답 가공 보정 — architecture +1 / decisions +1 / errors +2 / lessons +1) | 이전: 2026-05-02 (팀 로고 업로드 자동 정규화 pipeline — conventions +1)
