# 프로젝트 지식 목차
> 최종 갱신: 2026-05-04 (도메인 sub-agent 시스템 옵션 A 도입 — decisions +1 / `.claude/agents/live-expert.md` P1 박제) | 이전: 2026-05-04 (알기자 Phase 1 DB 영구 저장 마이그 — architecture +1 / decisions +2)
