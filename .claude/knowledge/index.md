# 프로젝트 지식 목차
> 최종 갱신: 2026-04-12 (--color-on-accent 도입 + 테마 반응형 텍스트 규칙)

## 파일별 요약
| 파일 | 항목 수 | 최종 업데이트 | 설명 |
|------|--------|------------|------|
| architecture.md | 16 | 2026-04-02 | 페이지별 구조, admin 개편, 프론트-백엔드 연결맵, 맞춤설정 시스템 |
| conventions.md | 12 | 2026-04-12 | 디자인 시스템, 디비전 체계, 대회 상태 4종, admin UI 패턴, --color-on-* 규칙 |
...
| 다크모드, 텍스트 가시성, --color-on-*, text-white 금지 | 테마 반응형 배경 위 텍스트는 --color-on-* 변수 사용 |
...
## 최근 추가된 지식 (최근 10건)
- [04-12] conventions: 테마 반응형 배경 위 텍스트는 --color-on-* 변수 사용 — text-white/color:'#fff' 고정 금지. --color-on-accent 신규 도입
