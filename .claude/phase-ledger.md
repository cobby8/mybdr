...
| **⑪ 운영 박제 (Phase 1C)** | 1C | 🔵 진행 중 (batch / 중형까지) | CLI | 2026-05-28 | PR #650 누적. **PR-1C-1~9 ✅** (`40d19db` UA1 / `9734de4` UA2+UC2 / `19dfa03` UB1 / `e4e629b` UA3 / `7e57690` UC1 / `08524bd` PA5 / `0cf3e1f` PA1 / `30f60a5` PA8 / `<PR-1C-9 commit>` PA4 SetupHub = B1 depends_on 시각화 + 잠금 toast + 모바일 sticky 공개 / setup-status.ts dependsOn optional 시각 메타 (vitest 50/50 판정 영향 0) / B7 운영 부재 → 보존). 모두 API/AppNav/가짜링크 0 / tsc 0. **사용자 결재: 중형 (PR-1C-8~13) 후 분할 / 대형 3 (PA2 1668 / Teams 1599 / Bracket 976) = 새 세션**. 잔여 현세션 = PR-1C-10~13. |
