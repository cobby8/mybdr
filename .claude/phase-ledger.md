...
| **⑪ 운영 박제 (Phase 1C)** | 1C | 🔵 진행 중 (batch / 중형까지) | CLI | 2026-05-28 | PR #650 누적. **PR-1C-1~8 ✅** (`40d19db` UA1 / `9734de4` UA2+UC2 / `19dfa03` UB1 / `e4e629b` UA3 / `7e57690` UC1 / `08524bd` PA5 옵션A / `0cf3e1f` PA1 4옵션 / `<PR-1C-8 commit>` PA8 Playoffs = 5섹션→4탭 / 8강·4강→순위전 통합 (운영 가변 라운드 데이터 왜곡 회피) / 결과탭 static 안내 (mock❌) / AdvancePlayoffsButton 재사용). 모두 API/AppNav/가짜링크 0 / tsc 0. **사용자 결재: 중형 PR (PR-1C-8~13)까지 진행 후 분할 / 대형 3 (PR-1C-14 PA2 1668 / 15 Teams 1599 / 16 Bracket 976) = 새 세션 batch**. 잔여 = PR-1C-9~13 (현 세션) + 대형 3 (새 세션). |
