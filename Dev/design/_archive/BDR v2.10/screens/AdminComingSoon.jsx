...
const COMING_SOON_LABELS = {
  ...
  adminReports: { eyebrow: 'ADMIN · 사용자', title: '신고 검토', phase: 'Phase C · 사용자 그룹', icon: 'report' },
...
// Phase A (Shell + Dashboard + Wizard), Phase B (콘텐츠 6) 및 Phase C (사용자+비즈니스 8) 박제 라우트 제외
const ADMIN_LIVE_ROUTES = new Set([
  // Phase B · 콘텐츠 그룹 (6)
  'adminTournaments', 'adminGames', 'adminTeams',
  'adminCourts', 'adminCommunity', 'adminNews',
  // Phase C · 사용자 + 비즈니스 그룹 (8)
  'adminUsers', 'adminReports', 'adminSuggestions',
  'adminPlans', 'adminPayments', 'adminCampaigns',
  'adminPartners', 'partnerAdminEntry'
]);
