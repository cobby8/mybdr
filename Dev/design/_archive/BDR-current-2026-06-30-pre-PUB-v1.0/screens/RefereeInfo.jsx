/* global React */
// ============================================================
// BDR v2.31 — RefereeInfo (RI1 · /referee-info · 신규 A 등급)
//   룰 8: refereeInfo = 유일 허용 신규 라우트 (gameReport/guestApps/referee 원본 ❌).
//   공개 정보 페이지 — 심판 제도 안내 + 자격 등급 + 지원 절차 + 정산 + FAQ.
//   심판 플랫폼 본체(/referee/*)는 E 등급 별도 셸 → 본 페이지는 CTA로 진입 link만.
//   상대 데이터 mock 0 (제도 안내 정적 콘텐츠).
// ============================================================
    ...
    <div className="page">
      <div className="page__inner ri-wrap">
        ...
        <header className="ri-hero">
          ...
          <h1 className="ri-hero__title">BDR 공인 심판으로<br /><span className="accent">전국 코트</span>에서 활동하세요</h1>
          ...
          <div className="ri-hero__cta">
            <a className="btn btn--primary btn--xl" href="#"><span className="ico material-symbols-outlined">how_to_reg</span>심판 지원하기</a>
            <a className="btn btn--accent btn--xl" href="#"><span className="ico material-symbols-outlined">login</span>심판 로그인</a>
          </div>
        </header>
        ...
        <div className="ri-cta">
          ...
          <div className="ri-cta__btns">
            <a className="btn btn--primary btn--xl" href="#"><span className="ico material-symbols-outlined">how_to_reg</span>심판 지원하기</a>
            <a className="btn btn--ghost" href="iu3-help.html"><span className="ico material-symbols-outlined">help</span>도움말 보기</a>
          </div>
        </div>
