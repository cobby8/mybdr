...
function GameReport({ setRoute }) {
  ...
  const players = [
    { id:1, name:'rdm_sniper', team:'A', pos:'G', num:7, color:'#DC2626', attended:true },
    { id:2, name:'rdm_forward', team:'A', pos:'F', num:23, color:'#DC2626', attended:true },
    { id:3, name:'rdm_pivot', team:'A', pos:'C', num:44, color:'#DC2626', attended:true },
    { id:4, name:'hoops_alex', team:'B', pos:'G', num:11, color:'#0F5FCC', attended:true },
    { id:5, name:'threes_jk', team:'B', pos:'F', num:22, color:'#0F5FCC', attended:true },
    { id:6, name:'paint_bk', team:'B', pos:'C', num:33, color:'#0F5FCC', attended:false },
  ];
