...
// Phase A~D + v2.13 + v2.14 + v2.15 신규 — 35 admin 라우트 안전망 (보조 7 추가)
const ADMIN_LIVE_ROUTES = new Set([
  ...
  // v2.15 · Phase E 보조 (7)
  'adminTournamentTeams', 'adminTournamentAdmins', 'adminTournamentRecorders',
  'adminTournamentSite', 'adminTournamentBracket', 'adminTournamentMatches',
  'adminTournamentDivisions'
]);
