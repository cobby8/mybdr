    ...
    <div className="page">
      ...
      {lightbox && (
        <div onClick={()=>setLightbox(null)} style={{
          ...
          <div className="lightbox-shell" onClick={e=>e.stopPropagation()} style={{maxWidth:1100, width:'100%', display:'grid', gridTemplateColumns:'minmax(0,1fr) 320px', gap:0, background:'var(--bg)', borderRadius:8, overflow:'hidden', boxShadow:'0 40px 120px rgba(0,0,0,.6)'}}>
