...
function Notifications({ setRoute }) {
  const items = [
    ...
    { id:9, type:'team', icon:'✉️', title:'몽키즈 팀에서 회원님을 초대했습니다', sub:'팀장 hoop_master · 가드 포지션 제안', time:'30분 전', unread:true, action:'teamInvite' },
    { id:10, type:'system', icon:'⚠️', title:'BDR+ 정기결제가 실패했습니다', sub:'카드 한도 초과 · 결제수단을 업데이트해주세요', time:'1시간 전', unread:true, action:'pricingFail' },
    { id:3, type:'comment', icon:'💬', title:'3POINT_슈님이 회원님 글에 댓글을 남겼습니다', sub:'"저도 그 코트 자주 가요. 다음에 같이..."', time:'1시간 전', unread:true, action:'post' },
    { id:11, type:'system', icon:'✅', title:'BDR Challenge Spring 2026 결제가 완료되었습니다', sub:'예약번호 BDR-T-00412 · ₩82,400', time:'2시간 전', unread:false, action:'pricingSuccess' },
