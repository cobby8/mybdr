...
### 6-1. 글로벌 카피 — 시안 우선 (2026-05-01 갱신)
- **갱신 결정 (2026-05-01)**: 시안 우선 정책으로 변경 — 룰 충돌 시 룰 업데이트
  - ✅ "서울 3x3 농구 커뮤니티" 허용 (v2.4 시안 5+건 보존)
  - ✅ "다음카페" 출신 표현 허용 (커뮤니티 맥락 보존)
- **이전 결정 (폐기)**: "서울 3x3 농구 커뮤니티" → "전국 농구 매칭 플랫폼" (commit 46e5d1b)
  - 폐기 사유: v2.4 시안 (Login.jsx / More.jsx / MyBDR.html footer / components.jsx Onboarding) 에 옛 카피 그대로 박제 의도. 사용자 결정 "새 시안 우선" 명시.
- **운영 코드**: 46e5d1b 으로 적용된 about/login 메타는 그대로 보존 (룰만 갱신)
- **회귀 금지**: 시안의 "서울 3x3 농구 커뮤니티" / "다음카페" 카피를 자동으로 "전국 농구 매칭 플랫폼" 으로 치환하지 말 것
