...
```
9. 글로벌 카피 — 시안 우선 (사용자 결정 2026-05-01 갱신)
   ✅ "서울 3x3 농구 커뮤니티" 허용 — v2.4 시안에 보존된 카피 그대로 사용
   ✅ "다음카페" 출신 표현 허용 — 커뮤니티 맥락 보존
   ❌ About 페이지 운영진 실명 박제 금지 (일반 라벨 사용) — 보존
```

> 사유: v2.4 시안 (Login/More/MyBDR.html footer/components.jsx Onboarding) 에
> "서울 3x3 농구 커뮤니티" / "다음카페" 카피 5+건 존재. 사용자가 "새 시안 우선,
> 룰 충돌 시 룰 업데이트" 결정 → 도시 한정 금지 룰 폐기.
> 이전 commit `46e5d1b` 은 운영 코드의 about/login 메타에만 적용 (보존).
