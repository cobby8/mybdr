...
const TEAMS = [
  { id: 'redeem',   name: '리딤',        tag: 'RDM',  color: '#E11D48', ink: '#fff', founded: 2019, wins: 34, losses: 12, rating: 1842 },
  { id: '3point',   name: '3POINT',     tag: '3PT',  color: '#F59E0B', ink: '#000', founded: 2020, wins: 28, losses: 15, rating: 1765 },
  { id: 'monkeys',  name: '몽키즈',       tag: 'MKZ',  color: '#10B981', ink: '#000', founded: 2018, wins: 41, losses: 9,  rating: 1920 },
  { id: 'iron',     name: 'IRON WOLVES', tag: 'IRW',  color: '#6B7280', ink: '#fff', founded: 2021, wins: 22, losses: 18, rating: 1640 },
  { id: 'zone',     name: 'THE ZONE',    tag: 'TZN',  color: '#8B5CF6', ink: '#fff', founded: 2017, wins: 36, losses: 14, rating: 1810 },
  { id: 'heat',     name: 'SEOUL HEAT',  tag: 'SHT',  color: '#DC2626', ink: '#fff', founded: 2022, wins: 19, losses: 11, rating: 1705 },
  { id: 'kings',    name: 'KINGS CREW',  tag: 'KGS',  color: '#0EA5E9', ink: '#fff', founded: 2016, wins: 45, losses: 20, rating: 1880 },
  { id: 'pivot',    name: 'PIVOT',       tag: 'PVT',  color: '#EC4899', ink: '#fff', founded: 2023, wins: 12, losses: 8,  rating: 1580 },
];
