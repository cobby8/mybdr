        ...
        <div>
          <div className="ts-card ts-card--flat" style={{ borderColor: "var(--ok)", marginBottom: 14 }}>
            <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "space-between", alignItems: "center", gap: 10 }}>
              ...
              <div style={{ display: "flex", gap: 8 }}><Btn variant="secondary" size="sm" iconRight="arrow-up-right">방문하기</Btn><Btn variant="danger" size="sm" onClick={() => { setPublished(false); show("비공개 전환(시연)"); }}>비공개 전환</Btn></div>
            </div>
          </div>
